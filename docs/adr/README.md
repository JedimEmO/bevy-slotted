...
|---|---|---|---|
| [0001](0001-script-runtime.md) | Script runtime strategy | Superseded by 0004 | Two adapters, mlua natively and piccolo on wasm. Neither is in the tree any more. |
...
| [0004](0004-web-runtime-luaur.md) | luaur is the only script runtime | Accepted | One runtime, luaur, on every target; on wasm an uncaught Lua error aborts the module and the host restarts. |
